...
const props = defineProps<{
    modelValue?: Partial<IJob>;
    onSubmit: (data: Omit<IJob, 'id'>) => void;
}>();

const form = reactive<Omit<IJob, 'id'>>({
    type: props.modelValue?.type ?? 'Full-Time',
    title: props.modelValue?.title ?? '',
    description: props.modelValue?.description ?? '',
    salary: props.modelValue?.salary ?? '',
    location: props.modelValue?.location ?? '',
    company: {
        name: props.modelValue?.company?.name ?? '',
        description: props.modelValue?.company?.description ?? '',
        contactEmail: props.modelValue?.company?.contactEmail ?? '',
        contactPhone: props.modelValue?.company?.contactPhone ?? '',
    },
});
